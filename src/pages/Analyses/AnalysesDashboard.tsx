...
import { BarChart2, Trophy, ChartLine, ChevronRight, Target, Zap } from "lucide-react";
...
export const AnalysesDashboard = () => {
    ...
    return (
        ...
        <div className="flex-1 p-4 md:p-8 max-w-5xl mx-auto w-full mb-20">
            <div className="mb-8">
                <h1 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-zinc-100">Performance Dashboard</h1>
                <p className="text-zinc-500 dark:text-zinc-400 mt-1">Track your progress and identify areas for improvement.</p>
            </div>
                    ...
                    <div className="space-y-6">
                        <Card className="p-6 bg-zinc-900 text-white border-none shadow-lg">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <p className="text-zinc-400 text-xs uppercase tracking-wider font-semibold">Strongest Subject</p>
                                    <p className="text-xl font-bold text-white">Mathematics</p>
                                    <p className="text-xs text-green-400 mt-1">Accuracy: 84%</p>
                                </div>
                                <div className="pt-4 border-t border-zinc-800">
                                    <p className="text-zinc-400 text-xs uppercase tracking-wider font-semibold">Needs Focus</p>
                        ...
                        <Card className="p-6 border-zinc-200 dark:border-zinc-800">
                            <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-4">Recent Scores</h3>
                            <div className="space-y-4">
                                {[
                                    { name: "Mock Test #4", score: "156/200", date: "2 days ago", color: "text-green-500" },
                                    { name: "Physics Quiz", score: "42/50", date: "4 days ago", color: "text-indigo-500" },
                                    { name: "Math Practice", score: "18/30", date: "1 week ago", color: "text-amber-500" },
                                ].map((item, idx) => (
