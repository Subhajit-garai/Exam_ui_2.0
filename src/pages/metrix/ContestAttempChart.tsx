...
const ContestAttemptChart = () => {
	...
	return (
		<motion.div
			className=' bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-4 border border-gray-700'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 0.3 }}
		>
			<h2 className='md:text-xl font-semibold  mb-4 text-primary'>Contest Attempt</h2>
