...
export const AcademicProfile = () => {
  ...
  // Redux state
  const { examCategorys, AvailableexamsShortCode } = useAppSelector(
    (state) => state.exam,
  );
  ...
  useEffect(() => {
    if (user.academic_profile) {
      setValue((prev) => ({
        ...prev,
        category: user.academic_profile?.category || "",
        exam: user.academic_profile?.exam || "",
        year: user.academic_profile?.year || "",
  ...
  useEffect(() => {
    if (value.category) {
      ...
      const isSavedProfile =
        ...
        value.category === user.academic_profile.category &&
        value.exam === user.academic_profile.exam;
