...
export const AvailableQuizzes = ({ filterMode, onCreateQuiz }: AvailableQuizzesProps) => {
    ...
    // Mock data - in real app this would come from API and be filtered there or here
    const allQuizzes = [
        { id: 1, subject: "Physics", mode: "1v1", title: "Kinematics Challenge", desc: "Master the basics of motion.", questions: 10 },
        { id: 2, subject: "Chemistry", mode: "1v2", title: "Organic Reactions", desc: "Test your knowledge of mechanisms.", questions: 15 },
        { id: 3, subject: "Maths", mode: "1v1", title: "Calculus Speed Run", desc: "Derivatives and Integrals.", questions: 8 },
        { id: 4, subject: "Biology", mode: "1v4", title: "Genetics Battle", desc: "Survival of the fittest.", questions: 20 },
    ];

    const filteredQuizzes = filterMode
        ? allQuizzes.filter(q => q.mode === filterMode)
        : allQuizzes;

    const handleJoin = async (quiz: any) => {
        try {
        ...
        // Assuming this route exists or will exist
