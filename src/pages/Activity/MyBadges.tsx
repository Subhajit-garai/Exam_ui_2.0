...
export const MyBadges = () => {
    ...
    if (loading) {
        return <div className="text-center text-sm text-muted-foreground py-4">Loading badges...</div>;
    }
    ...
    if (badges.length === 0) {
        return (
            <div className="text-center py-4 border border-dashed rounded-lg border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-xs text-muted-foreground mt-1">Complete challenges to earn badges!</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
                {badges.map((badge) => (
                    <Badge key={badge.id} variant="secondary" className="gap-1 py-1 pl-1 pr-3">
